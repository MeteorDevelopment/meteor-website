...
<div class="container">
    <div>
        ...
        <p>
            At Meteor Client, accessible from https://meteorclient.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            Meteor Client and how we use it.
        </p>
        <br />
        <p>
        ...
        <h2>Log Files</h2>
        <p>
            Meteor Client follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>
            ...
            Policy at the following <a href="https://policies.google.com/technologies/ads">URL</a>.
        </p>
        ...
        <p>
            ...
            used in their respective advertisements and links that appear on Meteor Client, which are sent directly to
        ...
        <br />
        <p>
            Note that Meteor Client has no access to or control over these cookies that are used by third-party
            advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>
        <p>
            Meteor Client's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <br />
        <p>
            Meteor Client does not knowingly collect any Personal Identifiable Information from children under the age
        ...
        <p>
            ...
            regards to the information that they shared and/or collect in Meteor Client. This policy is not applicable
